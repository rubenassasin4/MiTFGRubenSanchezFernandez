...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.6\textwidth]{imagenes/Interfaz de administración.png}
...
\begin{figure}[H]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.1\textwidth]{imagenes-diseño/estructura-aplicacion.png}
...
lista del metaobjeto que se ha configurado (``Áreas de impresión''). En la Figura~\ref{fig:metadatos} se pueden observar las definiciones de los tres tipos de metadatos configurados para los productos.
...
Posteriormente, junto con la implementación de funcionalidades adicionales, se llevó a cabo la creación de otros dos metadatos visibles en la Figura~\ref{fig:metafieldsAdicionales}: ``Canon digital'' y ``Doble pasada''. 
...
``session'' y ``count'', este último tiene un valor predeterminado según la constante ``DEFAULT\_META\_COUNT'' que representa el número de metadatos a crear.
...
\begin{figure}[H]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.6\textwidth]{imagenesUS3-modal/fetchAñadirCarrito.png}
...
propiedades definidas (artículos de personalización), mientras que la segunda parte (ver Figura~\ref{fig:runpart2}) se encarga de las líneas del carrito que no tienen propiedades definidas (artículos normales sin personalización).
