...
En esta sección se mostrará la investigación e implementación de los paquetes personalizados (\textit{customize bundles}) para agrupar y vincular los
...
``customize bundles'' \cite{paquete-personalizado}. Estas funciones se basan en destinos de extensión que inyectan código en la lógica de \textit{backend} de Shopify. La entrada de estas funciónes es un objecto JSON resultado de una
