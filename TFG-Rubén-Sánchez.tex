...
Finalmente, se añade al array el producto principal con su cantidad y propiedades. Se utiliza la API de Ajax para especificar 
algunos atributos y datos extra en cada producto añadido al carrito. Se asigna un id único a todos los productos pertenecientes 
