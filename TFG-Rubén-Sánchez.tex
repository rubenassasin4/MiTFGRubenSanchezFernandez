...
una aplicación versátil y escalable para Shopify, manteniendo el compromiso con la excelencia en el desarrollo de soluciones digitales para el comercio electrónico.

Las herramientas y tecnologías seleccionadas incluyen Shopify como plataforma base, React para el frontend para la parte de administración, Liquid, JavaScript y HTML 
para la extensión del tema, Node.js junto con Express para el backend, 
...
La implementación de la aplicación se dividió en cuatro partes: creación de la aplicación y extensión del tema de la tienda, desarrollo del backend, 
elaboración del frontend de la parte de administración, y detalles de la implementación de customize bundles. Se llevaron a cabo pruebas continuas 
para verificar el funcionamiento de las funcionalidades implementadas, con pruebas manuales en el frontend y backend.
...
The Bachelor's Thesis (TFG) has been carried out in collaboration with Upango, a company specialized in B2B digital transformations. Over time,
...
The main objective of the Bachelor's Thesis (TFG) is to develop an application for the Shopify platform, focused on enabling product customization
...
fundamental stages: initial analysis, requirements analysis and design, implementation, deployment in a sample store, and documentation of the process for the TFG.
...
In conclusion, the Final Degree Project (TFG) has successfully achieved all initially established objectives. A Shopify application has been 
