...
y configurar el número deseado de productos personalizados), el precio por unidad y el subtotal. Si el producto tiene canon digital, 
...
algunos atributos y datos necesarios en cada producto añadido al carrito. Estas se emplean para guardar junto al pedido toda la información sobre la impresión configurada, para que se reciba en el panel de administración de la tienda. Se asigna un id único a todos los productos pertenecientes 
al pedido de impresión, que servirá para asociar posteriormente todos estos productos en un solo paquete. Además, se añaden 
otros atributos, como el área a la que pertenece cada elemento, los números de colores en el cliché, las dimensiones en el trabajo, 
las observaciones y la imagen seleccionada.
