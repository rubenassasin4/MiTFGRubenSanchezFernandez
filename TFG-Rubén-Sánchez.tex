...
``NAMESPACE'', ``KEYS'', ``DESCRIPCION'', ``TIPO'', ``OWNERTIPO''. Dentro del bucle se ejecuta una consulta GraphQL para cada metafield a crear, cuya mutación
...
busca entre todas las funciones registradas en la tienda y filtra aquella que corresponde con esta aplicación y tiene el título ``cart-transform''.
