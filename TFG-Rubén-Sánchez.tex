...
En esta sección, se presentará la implementación dividida en cuatro partes: la creación de la aplicación y la extensión de tema, el desarrollo del \textit{backend}, la elaboración del \textit{frontend} de la parte de administración y una última sección donde se detallará el empleo de los paquetes personalizados (\textit{customize boundles}) y las modificaciones realizadas en un tema estandar de la tienda. Esta división 
