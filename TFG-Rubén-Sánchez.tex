...
elaboración del \textit{frontend} de la parte de administración, y detalles de la implementación de paquetes personalizados (\textit{customized bundles}). Se llevaron a cabo pruebas continuas 
...
\begin{enumerate}[label=\arabic*.]
    ...
    \item Al añadir productos al carrito, se deben incluir:
          ...
          \end{itemize}
    \item Se debe investigar si el uso de la funcionalidad de paquetes personalizados (\textit{customized bundles}) es adecuado para agrupar y vincular los productos relacionados en el carrito.
...
\clearpage
\subsubsection{Implementación de customized bundles y modificación de tema}
