...
\begin{enumerate}
    \item Realizar el análisis y estudio de las tecnologías y herramientas necesarias para el desarrollo de esta aplicación
    \item Analizar las funcionalidades y requisitos necesarios que debe tener la aplicación.
    \item Habiendo hecho el estudio de tecnologías y análisis de requisitos, realizar una división de tareas para obtener una serie de pasos a seguir para lograr el desarrollo. (Diseño)
    \item Implementar la aplicación siguiendo la división de tareas establecida.
    \item Desplegar la aplicación en una tienda de pruebas para comprobar su funcionamiento, realizar pruebas manuales y compras ficticias.
    \item Documentar todo este procedimiento para plasmarlo en el TFG
\end{enumerate}
