...
Para la integración de la aplicación con el panel de administración de las tiendas Shopify se ha hecho uso de \textbf{App Bridge}, una biblioteca de JavaScript
...
artículos, se ha creado en la aplicación lo que se conoce como \textbf{App Theme Extension}. Las extensiones de aplicaciones de temas permiten a los comerciantes
...
En cuanto al Backend de la aplicación se ha hecho uso de \textbf{Node.js}. Node es un entorno que trabaja en tiempo de ejecución, de código abierto, multi-plataforma, 
...
la redación del propio TFG en \textbf{LaTeX}, empleando una serie de extensiones que han facilitado el trabajo. 
...
Se ha empleado \textbf{Git} para llevar un control de versiones de la aplicación junto con \textbf{Azure DevOps}, una plataforma de Microsoft que ofrece una amplia
...
los clientes. Se ha implementado de tal manera que está preparada para añadir y modificar las funcionalidades facilmente, lo que la hace
...
ha permitido no solo cumplir con los requisitos establecidos, sino que también anticiparse a posibles necesidades futuras y
...
\begin{thebibliography}{100} % Elige 9 si tienes menos de 10 referencias
    ...
    \textit{Shopify}, dirección: \url{https://www.shopify.com/es/blog/guia-de-optimizacion-de-tasa-de-conversion} (visitado 29-03-2024).
    ...
    \bibitem{html} 
    HTML
    \textit{Html}, dirección: \url{https://es.wikipedia.org/wiki/HTML} (visitado 29-03-2024).

    \bibitem{javascript} 
    JavaScript
    \textit{JavaScript}, dirección: \url{https://developer.mozilla.org/es/docs/Learn/JavaScript/First_steps/What_is_JavaScript} (visitado 29-03-2024).
    ...
    \bibitem{app-bridge} 
    App Bridge
    \textit{App Bridge}, dirección: \url{https://shopify.dev/docs/api/app-bridge} (visitado 29-03-2024).

    \bibitem{polaris} 
    Polaris
    \textit{Polaris}, dirección: \url{https://shopify.dev/docs/apps/tools/polaris} (visitado 29-03-2024).

    \bibitem{theme} 
    Shopify theme
    \textit{Shopify theme}, dirección: \url{https://shopify.dev/docs/themes/getting-started} (visitado 29-03-2024).

    \bibitem{liquid} 
    Liquid
    \textit{Liquid}, dirección: \url{https://shopify.dev/docs/api/liquid} (visitado 29-03-2024).

    \bibitem{theme-app-extension} 
    Theme app extension
    \textit{Theme app extension}, dirección: \url{https://shopify.dev/docs/apps/online-store/theme-app-extensions} (visitado 29-03-2024).

    \bibitem{shopify-ajax-api} 
    Shopify Ajax API
    \textit{Shopify Ajax API}, dirección: \url{https://shopify.dev/docs/api/ajax} (visitado 29-03-2024).

    \bibitem{node} 
    Node.js
    \textit{Node.js}, dirección: \url{https://nodejs.org/en/learn/getting-started/introduction-to-nodejs} (visitado 29-03-2024).

    \bibitem{express} 
    Express
    \textit{Express}, dirección: \url{https://expressjs.com/} (visitado 29-03-2024).

    \bibitem{express-popular} 
    Express framework más popular
    \textit{Express es el mas pupular}, dirección: \url{https://kinsta.com/es/base-de-conocimiento/que-es-express/} (visitado 29-03-2024).
    ...
    \textit{API de administración GraphQL}, dirección: \url{https://shopify.dev/docs/api/admin-graphql} (visitado 31-03-2024).

    \bibitem{vsc} 
    Visual Studio Code
    \textit{Visual Studio Code}, dirección: \url{https://code.visualstudio.com/docs} (visitado 31-03-2024).

    \bibitem{latex} 
    LaTeX
    \textit{LaTeX}, dirección: \url{https://www.latex-project.org/} (visitado 31-03-2024).

    \bibitem{git} 
    Git
    \textit{Git}, dirección: \url{https://git-scm.com/} (visitado 31-03-2024).

    \bibitem{azure-devops} 
    Azure DevOps Página oficial
    \textit{Azure DevOps Página oficial}, dirección: \url{https://learn.microsoft.com/es-es/azure/devops/user-guide/what-is-azure-devops?view=azure-devops} (visitado 31-03-2024).
