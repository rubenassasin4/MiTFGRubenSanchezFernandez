...
\begin{figure}[ht]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.6\textwidth]{imagenes/Backlogs de Devops.png}
...
\begin{figure}[ht]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.6\textwidth]{imagenesUS3-section/funcioncargarLocales.png}
...
\begin{figure}[ht]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.4\textwidth]{imagenesUS3-modal/fetchAñadirCarrito.png}
...
\begin{figure}[ht]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.2\textwidth]{imagenes-tema/estructuraCartTransform.png}
