...
Empleando la Shopify CLI, hemos ejecutado el comando \textit{shopify app dev}, este al ejecutarse inicia un servidor local tanto para el backend como para el frontend, proporcionando
