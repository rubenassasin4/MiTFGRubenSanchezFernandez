...
la cual se subdivide a su vez en el desarrollo del \textit{frontend} (parte de administración) y del \textit{backend}; la configuración de la extensión 
"theme app extension"; y la implementación de la extensión ``cart-transform'', encargada de transformar el carrito de compras y aplicar los \textit{customized bundles}.
