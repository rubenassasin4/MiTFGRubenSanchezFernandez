...
la implementación del proyecto. En el Anexo~\ref{sec:tareas}, pueden observarse dichas tareas.
...
introducir el número de colores que permite cada trabajo de la tienda. Por último como se ha comentado, cada producto normal de la tienda debe contar con sus correspondientes áreas de impresión, por lo que se debe crear otro \textit{metafield} para el tipo de elemento ``Producto''. Este será una 
