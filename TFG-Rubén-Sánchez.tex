...
\clearpage
\subsubsection{Implementación de customize bundles y modificación de tema estandar}
...
\begin{figure}[ht]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes-tema/estructuraCartTransform.png}
...
\begin{figure}[ht]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes-tema/queryCartTransform.png}
...
\begin{figure}[ht]
    \floatplacement{figure}{!t}
    \centering
    \includegraphics[width=0.8\textwidth]{imagenes-tema/creacionSeccionTema.png}
