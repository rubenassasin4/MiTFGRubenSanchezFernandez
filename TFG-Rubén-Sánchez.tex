...
La implementación de la aplicación se dividió en tres partes fundamentales: creación de la aplicación (\textit{backend} y \textit{frontend}), creación de la extensión del tema de la tienda (interfaz de la tienda), desarrollo del \textit{backend}, 
