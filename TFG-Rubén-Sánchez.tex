...
\begin{itemize}
    \item \textbf{Tarea 1:} Crear una Aplicación y una Extensión de Tema:
          \begin{itemize}[label=--]
              \item Descripción: Crear una aplicación para Shopify con el template Node e instalarla en la tienda. Crear un theme app extensión en la aplicación para poder añadir una nueva sección con el botón a las plantillas de ficha de producto a través del personalizador del theme.
          \end{itemize}
    \item \textbf{Tarea 2:} Crear la sección y el botón y mostrarlo solo si el Producto es de Impresión:
          \begin{itemize}[label=--]
...
\begin{itemize}
    \item \textbf{Tarea 1:} Crear Manualmente los Metafields y Metaobjects Necesarios:
          \begin{itemize}[label=--]
              \item \textbf{Descripción:} Crear manualmente los metafields y metaobjects necesarios para la gestión de trabajos de impresión.
          \end{itemize}
          
    \item \textbf{Tarea 2:} Mejora: Creación Automática de Metafields y Metaobjects por parte de la Aplicación:
          \begin{itemize}[label=--]
              \item \textbf{Descripción:} Implementar una funcionalidad mejorada en la aplicación que permita la creación automática de todos los metafields y metaobjects necesarios.
              \item \textbf{Pasos:}
              \begin{itemize}
                  \item Crear un botón en el panel de administración de la aplicación para iniciar el proceso de creación automática.
                  \item Realizar una verificación previa para comprobar si los metafields y metaobjects ya existen; en caso afirmativo, la aplicación no realizará ninguna acción adicional.
              \end{itemize}
          \end{itemize}
\end{itemize}
