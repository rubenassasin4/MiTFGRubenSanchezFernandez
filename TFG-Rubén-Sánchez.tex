...
\begin{enumerate}[label=\arabic*.]
    ...
    \item Los selectores de trabajo y colores de las áreas que el usuario no haya seleccionado deberán aparecer como desactivados.
...
\begin{itemize}
    \item \textbf{Tarea 1:} Crear Manualmente los Metafields y Metaobjects Necesarios (Tarea 3):
          \begin{itemize}[label=--]
    ...
    \item \textbf{Tarea 2:} Mejora: Creación Automática de Metafields y Metaobjects por parte de la Aplicación (Tarea 4):
          \begin{itemize}[label=--]
