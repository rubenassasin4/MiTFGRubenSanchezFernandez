...
\begin{itemize}
    ...
    \item \textbf{Tarea 3:} Añadir Líneas de Canon al Carrito y Asociarlas a sus Productos Correspondientes con customize bundles:
          \begin{itemize}[label=--]
              ...
              Este canon digital se deberá añadir tanto como los productos ``normales'' que no sean de impresión, como para los productos de impresión.
              Para los productos de impresión se deberá realizar una configuración adicional para que en caso de que el producto personalizado cuente con canon digital, se añada la cantidad adecuada de productos canon de un céntimo.
              Para los productos normales, se debe investigar si modificando la funcionalidad de los cart-tranform existente, se pueden extender los productos ``normales'' que cuenten con canon digital y que en el carrito, se cree automáticamente un paquete con cada producto normal y su canon asociado, con la cantidad adecuada.
          \end{itemize}
\end{itemize}
